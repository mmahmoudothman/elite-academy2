                ...
                <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-slate-100 p-6 sm:p-8 space-y-4 sm:space-y-5 shadow-sm">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      {errors.name && touched.name && <p className="text-xs text-red-500 font-bold mt-1 ml-1">{errors.name}</p>}
                    </div>
                    <div>
                      ...
                      {errors.email && touched.email && <p className="text-xs text-red-500 font-bold mt-1 ml-1">{errors.email}</p>}
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      {errors.phone && touched.phone && <p className="text-xs text-red-500 font-bold mt-1 ml-1">{errors.phone}</p>}
                    </div>
                    <div>
                      <label className="block text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1.5 ml-1">{t.contact?.subject_label || 'Subject'}</label>
                  ...
                  <div>
                    <label className="block text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1.5 ml-1">{t.contact?.inquiry_type_label || 'Inquiry Type'}</label>
                  ...
                  <div>
                    <label className="block text-[10px] font-black uppercase tracking-widest text-slate-400 mb-1.5 ml-1">{t.contact?.message_label || 'Message'} *</label>
                    ...
                    {errors.message && touched.message && <p className="text-xs text-red-500 font-bold mt-1 ml-1">{errors.message}</p>}
                  </div>
