    ...
    <section id="instructors" className="py-16 sm:py-24 lg:py-32 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16 lg:mb-24 max-w-3xl mx-auto space-y-4 sm:space-y-6">
          <span className="text-xs font-black text-[#3d66f1] uppercase tracking-[0.3em] sm:tracking-[0.4em]">{t.instructors.badge}</span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10">
          {instructorData.map((instructor) => (
            <div
              key={instructor.id}
              className="group flex flex-col h-full bg-slate-50 rounded-2xl sm:rounded-3xl lg:rounded-[2.5rem] overflow-hidden border border-slate-100 transition-all duration-500 hover:shadow-2xl hover:shadow-[#3d66f1]/10 hover:bg-white cursor-pointer"
            ...
            >
              ...
              <div className="relative aspect-[3/4] overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-slate-900/80 via-slate-900/20 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-500 flex flex-col items-center justify-center">
                  <div className="w-12 h-12 sm:w-16 sm:h-16 bg-white/95 rounded-full flex items-center justify-center shadow-2xl scale-75 group-hover:scale-100 transition-transform duration-500 mb-2 sm:mb-3">
                    <svg className="w-5 h-5 sm:w-7 sm:h-7 text-[#3d66f1]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {instructor.videoUrl && (
                  <div className="absolute top-3 right-3 sm:top-4 sm:right-4 rtl:right-auto rtl:left-3 sm:rtl:left-4 bg-white/90 backdrop-blur-sm rounded-full px-2.5 py-1 sm:px-3 sm:py-1.5 flex items-center gap-1 sm:gap-1.5 shadow-lg">
                    <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-[#3d66f1]" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="absolute bottom-4 left-4 right-4 sm:bottom-6 sm:left-6 sm:right-6 translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
                  <span className="text-[9px] sm:text-[10px] font-black uppercase tracking-widest text-[#0da993] mb-1 sm:mb-2 block">{t.instructors.specialization}</span>
              ...
              <div className="p-5 sm:p-7 lg:p-10 flex flex-col flex-1">
                <div className="mb-4 sm:mb-6">
                  <h3 className={`text-lg sm:text-xl lg:text-2xl font-black font-heading mb-1 text-slate-900 group-hover:text-[#3d66f1] transition-colors ${language === 'ar' ? 'font-bold' : ''}`}>
                    {instructor.name}
                  </h3>
                  <p className="text-[#3d66f1] font-bold text-xs sm:text-sm uppercase tracking-widest">{instructor.role}</p>
                </div>
                ...
                <div className="space-y-4 sm:space-y-6 flex-1">
                    ...
                    <ul className="space-y-1.5 sm:space-y-2">
                      {instructor.qualifications.slice(0, 3).map((qual, idx) => (
                        <li key={idx} className="flex items-start gap-2 sm:gap-3 text-slate-600 text-xs sm:text-sm font-medium">
                          <div className="mt-1.5 w-1 h-1 sm:w-1.5 sm:h-1.5 rounded-full bg-[#3d66f1] flex-shrink-0"></div>
                          {qual}
                        </li>
                      ))}
                    </ul>
                  ...
                  <p className="text-slate-500 text-xs sm:text-sm leading-relaxed italic border-s-2 border-[#3d66f1]/15 ps-3 sm:ps-4 line-clamp-2">
                ...
                <div className="mt-5 sm:mt-8 pt-5 sm:pt-8 border-t border-slate-100">
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <span className="text-[#3d66f1] font-bold text-xs sm:text-sm flex items-center gap-1.5 sm:gap-2 group-hover:gap-2 sm:group-hover:gap-3 transition-all whitespace-nowrap">
                      {t.instructors.view_profile}
            ...
            >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 lg:p-8">
                  <div className="flex items-end justify-between gap-3 sm:gap-4">
                    <div className="min-w-0">
                      <p className="text-[#0da993]/70 font-bold text-[10px] sm:text-xs uppercase tracking-[0.15em] sm:tracking-[0.2em] mb-1 sm:mb-2">{profileInstructor.role}</p>
              ...
              <div className="p-4 sm:p-6 lg:p-10 space-y-5 sm:space-y-6 lg:space-y-8">
                ...
                <div className="md:hidden bg-slate-50 rounded-xl sm:rounded-2xl p-3 sm:p-4 flex items-center gap-2.5 sm:gap-3">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 text-[#3d66f1] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {/* Specialization */}
                <div>
                  <span className="text-[9px] sm:text-[10px] font-black text-[#0da993] uppercase tracking-widest block mb-2 sm:mb-3">{t.profile_modal.specialization}</span>
                  <div className="inline-flex items-center gap-2 bg-[#3d66f1]/10 border border-[#3d66f1]/15 rounded-xl sm:rounded-2xl px-3 py-2 sm:px-5 sm:py-3">
                    <svg className="w-4 h-4 sm:w-5 sm:h-5 text-[#3d66f1]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                    </svg>
                    <span className="text-[#0d1b2a] font-bold text-sm sm:text-base">{profileInstructor.specialization}</span>
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                    {profileInstructor.qualifications.map((qual, idx) => (
                      <div key={idx} className="flex items-start gap-2.5 sm:gap-3 bg-slate-50 rounded-lg sm:rounded-xl px-3 py-2.5 sm:px-4 sm:py-3 border border-slate-100">
                        <div className="mt-0.5 w-4 h-4 sm:w-5 sm:h-5 rounded-md sm:rounded-lg bg-[#3d66f1]/15 flex items-center justify-center flex-shrink-0">
                          <svg className="w-2.5 h-2.5 sm:w-3 sm:h-3 text-[#3d66f1]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  ...
                  <div className="bg-gradient-to-br from-slate-50 to-[#3d66f1]/5 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-slate-100">
                    <div className="flex gap-2 sm:gap-3">
                      <svg className="w-6 h-6 sm:w-8 sm:h-8 text-[#3d66f1]/30 flex-shrink-0 -mt-0.5 sm:-mt-1" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex flex-col sm:flex-row gap-2.5 sm:gap-3 pt-1 sm:pt-2">
                  {profileInstructor.videoUrl && (
                    <button
                      ...
                      className="flex-1 py-3 sm:py-4 bg-slate-900 text-white rounded-xl sm:rounded-2xl text-xs sm:text-sm font-black uppercase tracking-widest hover:bg-[#3d66f1] transition-all flex items-center justify-center gap-2 sm:gap-3 active:scale-[0.98]"
                    >
