        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1">
            ...
            <input
              ...
              className={`w-full bg-slate-50 border rounded-xl px-4 py-3 focus:border-[#0da993] focus:bg-white outline-none transition-all text-slate-900 font-bold text-sm ${errors.nameEn ? 'border-red-400' : 'border-slate-100'}`}
            />
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              className={`w-full bg-slate-50 border rounded-xl px-4 py-3 focus:border-[#0da993] focus:bg-white outline-none transition-all text-slate-900 font-bold text-sm ${errors.nameAr ? 'border-red-400' : 'border-slate-100'}`}
            />
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              className="w-full bg-slate-50 border border-slate-100 rounded-xl px-4 py-3 focus:border-[#0da993] focus:bg-white outline-none transition-all text-slate-900 font-bold text-sm font-mono"
            />
          </div>
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  value={form.color || '#0da993'}
                  onChange={(e) => setForm({ ...form, color: e.target.value })}
                  className="flex-1 bg-slate-50 border border-slate-100 rounded-xl px-3 py-2.5 focus:border-[#0da993] focus:bg-white outline-none transition-all text-slate-900 font-bold text-xs font-mono"
                />
              </div>
            </div>
            <div className="space-y-1">
