      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {testimonials.length === 0 ? (
          <div className="text-center py-12">
            <div className="w-16 h-16 bg-[#0da993]/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
              <svg className="w-8 h-8 text-[#0da993]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  {testimonial.image ? (
                    ...
                    <div className="w-12 h-12 bg-[#0da993]/10 rounded-full flex items-center justify-center text-[#0da993] font-bold text-lg">
                ...
                {testimonial.courseId && (
                  <div className="mt-4 pt-4 border-t border-slate-100">
                    <span className="text-[10px] font-black text-[#0da993] uppercase tracking-widest">
                      {testimonial.courseId}
                    </span>
                  </div>
                )}
